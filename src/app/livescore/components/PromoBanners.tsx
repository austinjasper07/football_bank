...
export function PromoBanners() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6">
      <div className="bg-brand-nairabet rounded-lg p-3 sm:p-4 text-white relative overflow-hidden">
      ...
      <div className="bg-brand-oneXbet rounded-lg p-3 sm:p-4 text-white relative overflow-hidden">
        <div className="relative z-10">
      ...
      <div className="bg-brand-betano rounded-lg p-3 sm:p-4 text-white relative overflow-hidden">
        <div className="relative z-10">

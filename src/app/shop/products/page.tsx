          ...
          <div className="max-w-6xl mx-auto flex flex-wrap justify-center gap-4 mb-12">
            {['All Products', 'Football Boots', 'Jerseys', 'Balls', 'Training Gear', 'Accessories'].map((cat, idx) => (
              <span
                key={cat}
                className={`${
                  idx === 0 ? 'bg-accent-red text-white' : 'bg-primary-card border border-divider text-primary-text hover:text-accent-red'
      ...
      <section className="pb-16">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Sample Product Card */}
            <div className="bg-primary-card rounded-xl border border-divider shadow-lg overflow-hidden hover:border-accent-red transition-colors">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mb-4">
                  <span className="text-accent-red font-bold text-xl">£189.99</span>
                  <div className="flex items-center gap-1">
                    <i className="fa-solid fa-star text-accent-amber text-sm"></i>
                    <span className="text-primary-muted text-sm">4.8 (124)</span>
                  </div>
                </div>
                <button className="w-full bg-accent-red hover:bg-opacity-90 text-white py-3 rounded-lg font-medium transition-colors">
                  Add to Cart
                </button>
              </div>
            </div>
